            ...
            <div class="card">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1">
                                        ...
                                        @foreach ($option->pivot->features as $feature)
                                            <li>
                                                ...
                                                @switch($option->type)
                                                    @case(1)
                                                        <button
                                                            class="w-20 h-8 font-semibold uppercase text-sm rounded-lg 
                                                            {{ $selectedFeatures[$option->id] == $feature['id'] ? 'bg-purple-600 text-white' : 'border border-gray-200 text-gray-700' }}"
                        ...
                        <button class="btn btn-purple w-full mb-6" wire:click="add_to_cart"
