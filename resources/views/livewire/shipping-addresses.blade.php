            ...
            @else
                @if ($editAddress->id)
                    ...
                    <div class="grid grid-cols-4 gap-4">
                        ...
                        {{-- Dirección --}}
                        <div class="col-span-3">
                            <x-input wire:model="editAddress.address" class="w-full" type="text"
                                placeholder="Dirección" />
                        </div>

                        {{-- Provincia --}}
                        <div class="col-span-2">
                            <x-input wire:model="editAddress.province" class="w-full" type="text"
                                placeholder="Provincia" />
                        </div>

                        {{-- Ciudad --}}
                        <div class="col-span-2">
                            <x-input wire:model="editAddress.city" class="w-full" type="text"
                                placeholder="Ciudad" />
                        </div>

                        {{-- Codigo postal --}}
                        <div class="col-span-1">
                            <x-input wire:model="editAddress.zip_code" class="w-full" type="text"
                                placeholder="Codigo postal" />
                        </div>
